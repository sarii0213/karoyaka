...
class TurboDeviseController < ApplicationController
  class Responder < ActionController::Responder
    def to_turbo_stream
    ...
    rescue ActionView::MissingTemplate => e # handle the case when no template being found
      raise e if get? # if it's get request, just reraise the error
      ...
      if has_errors? && default_action
        ...
        navigation_behavior e # redirect to index page
      end
    end
  end
